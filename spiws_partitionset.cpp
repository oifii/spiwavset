	...
	for(it=partitionvector.begin(); it<partitionvector.end(); it++)
	{
		...
		if(*it!=NULL) 
		{
			...
			if(1)
			{
				...
				cout << endl << "number of midieventset in this partition = " << pPartition->midieventsetvector.size() << endl;
				cout << "miditrackname for this partition = " << pPartition->miditrackname << endl;
				cout << "length of this partition = " << GetLengthInSeconds(pPartition) << endl;
				//1) create wavset
			...
			else
			{
				...
				cout << "miditrackname for this partition = " << pPartition->miditrackname << endl;
				cout << "length of this partition = " << GetLengthInSeconds(pPartition) << endl;
				cout << endl << "number of instrument in this instrumentset = " << pInstrumentSet->instrumentvector.size() << endl;
				cout << "will now play each partition once with each instrument = " << endl;
